...
class TColors {
  ...
  // Icon colors
  static const Color iconPrimaryLight = Color(0xFF85B2E8); // Theme Nightingale Gray 80
  // static const Color iconPrimary2Light = Color(0xFFAACBF3); // Theme Nightingale Gray 80
  static const Color iconPrimary2Light = Color(0xFFF4F6FA); // Theme Nightingale Gray 80
